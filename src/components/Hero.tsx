      ...
      <div className="container mx-auto px-6 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          <div className="relative z-10 rounded-2xl overflow-hidden border border-white/10 aspect-[4/5] bg-gradient-to-br from-legal-blue to-black group">
            <div className="absolute inset-0 bg-[url('/legal_aid/images/audhara.png')] bg-cover bg-center opacity-40 group-hover:scale-105 transition-transform duration-700" />
